...
public class Gezin {
    ...
    private List<KostenOverzicht> kostenoverzichten;
...
//    public Gezin(String naam, List<Gesprek> gesprekken, List<KostenOverzicht> kostenoverzichten,  List<Gebruiker> gezinsLeden){
//        this.gezinsNaam = naam;
//        this.gesprekken = gesprekken;
//        this.kostenoverzichten = kostenoverzichten;
